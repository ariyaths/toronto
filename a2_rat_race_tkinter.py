...
def main():
    ...
    with open(maze_filename, 'r', newline="\r\n") as maze_file:
    ...
    app.focus_force() # experimental line of code
    # https://www.coursera.org/learn/program-code/programming/6RJls/rat-race/discussions/threads/hUk3N5weEeigSBJTIs4Mdg
    app.mainloop()
